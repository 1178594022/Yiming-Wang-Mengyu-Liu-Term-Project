...
for num1 in range(days):
    ...
    for i in l:
        if i.inffected == True and i.masked == True and i.vaccinated == True:
            count5 = count5 + 1
    print(f'-----------------------------------------Day {num1 + 1}-----------------------------------------')
    print(f'{count1} number of people inffected out of {number_of_people} people')
    print(f'{count2-1} people out of the {number_of_unprotected} unprotected people are inffected')
    print(f'{count3} people out of the {number_of_only_masked} masked but not vaccinated people are inffected')
    print(f'{count4} people out of the {number_of_only_vaccinated} vaccinated but not masked people are inffected')
    print(f'{count5} people out of the {number_of_both} both masked and vaccinated people are inffected')
    day.append(num1+1)
